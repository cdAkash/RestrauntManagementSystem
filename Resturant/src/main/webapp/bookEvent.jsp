			...
			if (!username.equals("") || username != null) {
			    ...
			    <div class="d-inline-flex" style="padding-bottom: 22px;height: 194.222px;">
			        <div class="container-fluid">
			            <div class="row">
			                <div class="col head-img"><img class="img-fluid d-block" src="assets/img/bookevent.png"></div>
			            </div>
			        </div>
			    </div>
			    <div>
			        <h1 class="text-uppercase text-bg-dark" style="font-family: 'Cormorant Garamond', serif;color: rgb(246,247,248);text-align: center;">Book for an event</h1>
			    </div>
			    <div style="width: auto;">
			        <form style="padding-left: 54px;padding-right: 54px;">
			        	<input type="hidden" value=<%= user %> id="name">
			            <div class="row">
			                <div class="col-lg-4" style="color: rgb(240,242,245);width: 367px;">
			                    <p style="padding-top: 5px;">Time and date:</p>
			                </div>
			                <div class="col"><input class="form-control form-control-lg" type="datetime-local" id="datetime"></div>
			            </div>
			            <div class="row">
			                <div class="col-lg-4" style="color: rgb(240,242,245);width: 367px;">
			                    <p style="padding-top: 5px;">No. of Person:</p>
			                </div>
			                <div class="col"><input class="form-control form-control-lg" type="number" id="number"></div>
			            </div>
			            <div class="row">
			                <div class="col-lg-4" style="color: rgb(240,242,245);width: 367px;">
			                    <p style="padding-top: 5px;">Instructions:</p>
			                </div>
			                <div class="col"><input class="form-control form-control-lg" type="text" id="instructions"></div>
			            </div>
			            <div class="row">
			                <div class="col-lg-4" style="color: rgb(240,242,245);width: 367px;">
			                    <p style="padding-top: 5px;">Event Name:</p>
			                </div>
			                <div class="col"><input class="form-control form-control-lg" type="text" id="event"></div>
			            </div>
			            <div class="row">
			                <div class="col" style="text-align: center;"><input class="btn btn-light btn-lg text-uppercase" type="submit" value="Submit" onclick="booking()" style="background: transparent;color: rgb(189,90,72);border-radius: 0px;font-family: poppins;border-style: dashed;"></div>
			            </div>
			        </form>
			    </div>
			    <div>
			    ...
			    <script type="text/javascript">
			    	function booking() {
			    		...
			    		alert("Hi, " + user + "\nWe have received your event booking request for " + num + " at " + datetime + "\nConfirmation through email and sms will be sent shortly!");
			    	}
			    </script>
