			...
			if (!username.equals("") || username != null) {
			    ...
			    <div style="padding-bottom: 22px;">
			        <div class="container-fluid">
			            <div class="row">
			                <div class="col head-img"><img class="img-fluid" src="assets/img/MEUpAGEiMAGE1.png"></div>
			            </div>
			        </div>
			    </div>
			    <div>
			        <div class="container">
			            <div class="row">
			                <div class="col menu-img-col"><img class="img-fluid d-inline-block" src="assets/img/BREAKFAST.svg"></div>
			                <div class="col menu-img-col"><img class="img-fluid d-inline-block" src="assets/img/beveragesMenu.svg"></div>
			            </div>
			        </div>
			    </div>
			    <div style="padding-top: 19px;">
			        <div class="container-fluid wrapper">
			            <div class="row four-img-row">
			                <div class="col four-img-col"><img class="img-fluid" src="assets/img/img1.svg"></div>
			                <div class="col four-img-col"><img class="img-fluid" src="assets/img/img2.svg"></div>
			                <div class="col four-img-col"><img class="img-fluid" src="assets/img/img3.svg"></div>
			                <div class="col four-img-col"><img class="img-fluid" src="assets/img/img4.svg"></div>
			            </div>
			        </div>
			    </div>
			    <div>
			        <div class="container">
			            <div class="row">
			                <div class="col menu-img-col"><img class="img-fluid d-inline-block" src="assets/img/desertMenuImage.svg"></div>
			            </div>
			        </div>
			    </div>
			    <div style="padding-bottom: 22px;">
			        <div class="container-fluid">
			            <div class="row">
			                <div class="col head-img"><img class="img-fluid" src="assets/img/registerPageImage.svg"></div>
			            </div>
			        </div>
			    </div>
			    <div>
