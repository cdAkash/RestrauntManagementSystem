			...
			if (!username.equals("") || username != null) {
			    ...
			    <div class="d-inline-flex" style="padding-bottom: 22px;height: 194.222px;">
			        <div class="container-fluid">
			            <div class="row">
			                <div class="col head-img"><img class="img-fluid d-block" src="assets/img/DingOUT.png"></div>
			            </div>
			        </div>
			    </div>
			    <div>
			        <h1 class="text-uppercase text-bg-dark" style="font-family: 'Cormorant Garamond', serif;color: rgb(246,247,248);text-align: center;">Dining out</h1>
			    </div>
			    <div style="width: auto;">
			        <form style="padding-left: 54px;padding-right: 54px;">
			            ...
			            <div class="row">
			                <div class="col" style="text-align: center;"><button class="btn btn-light btn-lg text-uppercase" type="submit" onclick="booking()" style="background: transparent;color: rgb(189,90,72);border-radius: 0px;font-family: poppins;border-style: dashed;">Submit</button></div>
			            </div>
			        </form>
			    </div>
			    <div>
			    ...
			    <script type="text/javascript">
			    	function booking() {
			    		...
			    		alert("Hi, " + user + "\nYour table for " + num + " at " + datetime + "\nhas been booked with temporary booking id " + x + "\nNote: Please not the booking id for future references!");
			    	}
			    </script>
