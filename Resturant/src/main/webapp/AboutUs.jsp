		...
		try {
			...
			if (ck != null) {
				...
				if (!username.equals("") || username != null) {
				    ...
				    <div>
				        <div class="container py-4 py-xl-5" style="color: rgb(238,241,244);font-family: 'Cormorant Garamond', serif;">
				            ...
				            <div class="row">
				                <div class="col">
				                    <div class="card bg-dark border-0 shadow-none" style="background: transparent;">
				                        <div class="card-body text-center d-flex flex-column align-items-center p-0"><img class="rounded-circle mb-3 fit-cover" data-bss-hover-animate="tada" width="130" height="130" src="assets/img/EventIMG.jpg">
				                            <h5 class="fw-bold card-title mb-0" style="color: var(--bs-card-bg);font-size: 21px;"><strong>Akash Yadav</strong></h5>
				                            <p class="text-muted card-text mb-2" style="color: var(--bs-card-bg);">Frontend Developer</p>
				                ...
				                <div class="col">
				                    <div class="card bg-dark border-0 shadow-none" style="background: transparent;">
				                        <div class="card-body text-center d-flex flex-column align-items-center p-0"><img class="rounded-circle mb-3 fit-cover" data-bss-hover-animate="tada" width="130" height="130" src="https://cdn.bootstrapstudio.io/placeholders/1400x800.png">
				                            <h5 class="fw-bold card-title mb-0" style="color: var(--bs-card-bg);font-size: 21px;"><strong>Niladri Kundu</strong></h5>
				                            <p class="text-muted card-text mb-2" style="color: var(--bs-card-bg);">Backend Deveoper</p>
				                            <ul class="list-inline fs-6 text-muted w-100 mb-0">
				                                <li class="list-inline-item text-center">
				                                    <div class="d-flex flex-column align-items-center"><svg xmlns="http://www.w3.org/2000/svg" width="1em" height="1em" fill="currentColor" viewBox="0 0 16 16" class="bi bi-facebook">
				                                            <path d="M16 8.049c0-4.446-3.582-8.05-8-8.05C3.58 0-.002 3.603-.002 8.05c0 4.017 2.926 7.347 6.75 7.951v-5.625h-2.03V8.05H6.75V6.275c0-2.017 1.195-3.131 3.022-3.131.876 0 1.791.157 1.791.157v1.98h-1.009c-.993 0-1.303.621-1.303 1.258v1.51h2.218l-.354 2.326H9.25V16c3.824-.604 6.75-3.934 6.75-7.951z"></path>
				            ...
				            <div class="row">
				                <div class="col">
				                    <div class="card bg-dark border-0 shadow-none" style="background: transparent;">
				                        <div class="card-body text-center d-flex flex-column align-items-center p-0"><img class="rounded-circle mb-3 fit-cover" data-bss-hover-animate="tada" width="130" height="130" src="https://cdn.bootstrapstudio.io/placeholders/1400x800.png">
				                            <h5 class="fw-bold card-title mb-0" style="color: var(--bs-card-bg);font-size: 21px;"><strong>Priyam Mondal</strong></h5>
				                            <p class="text-muted card-text mb-2" style="color: var(--bs-card-bg);">Designer</p>
				                            <ul class="list-inline fs-6 text-muted w-100 mb-0">
				                                <li class="list-inline-item text-center">
				                                    <div class="d-flex flex-column align-items-center"><svg xmlns="http://www.w3.org/2000/svg" width="1em" height="1em" fill="currentColor" viewBox="0 0 16 16" class="bi bi-facebook">
				                                            <path d="M16 8.049c0-4.446-3.582-8.05-8-8.05C3.58 0-.002 3.603-.002 8.05c0 4.017 2.926 7.347 6.75 7.951v-5.625h-2.03V8.05H6.75V6.275c0-2.017 1.195-3.131 3.022-3.131.876 0 1.791.157 1.791.157v1.98h-1.009c-.993 0-1.303.621-1.303 1.258v1.51h2.218l-.354 2.326H9.25V16c3.824-.604 6.75-3.934 6.75-7.951z"></path>
				                ...
				                <div class="col">
				                    <div class="card bg-dark border-0 shadow-none" style="background: transparent;">
				                        <div class="card-body text-center d-flex flex-column align-items-center p-0"><img class="rounded-circle mb-3 fit-cover" data-bss-hover-animate="tada" width="130" height="130" src="https://cdn.bootstrapstudio.io/placeholders/1400x800.png">
				                            <h5 class="fw-bold card-title mb-0" style="color: var(--bs-card-bg);font-size: 21px;"><strong>Arpita Patra</strong></h5>
				                            <p class="text-muted card-text mb-2" style="color: var(--bs-card-bg);">Designer</p>
				                            <ul class="list-inline fs-6 text-muted w-100 mb-0">
				                                <li class="list-inline-item text-center">
				                                    <div class="d-flex flex-column align-items-center"><svg xmlns="http://www.w3.org/2000/svg" width="1em" height="1em" fill="currentColor" viewBox="0 0 16 16" class="bi bi-facebook">
				            ...
				            <div class="row">
				                <div class="col">
				                    <div class="card bg-dark border-0 shadow-none" style="background: transparent;">
				                        <div class="card-body text-center d-flex flex-column align-items-center p-0"><img class="rounded-circle mb-3 fit-cover" data-bss-hover-animate="tada" width="130" height="130" src="https://cdn.bootstrapstudio.io/placeholders/1400x800.png">
				                            <h5 class="fw-bold card-title mb-0" style="color: var(--bs-card-bg);font-size: 21px;"><strong>Sohom Nandi</strong></h5>
				                            <p class="text-muted card-text mb-2" style="color: var(--bs-card-bg);">UI/UX designer</p>
				                            <ul class="list-inline fs-6 text-muted w-100 mb-0">
				                                <li class="list-inline-item text-center">
				                                    <div class="d-flex flex-column align-items-center"><svg xmlns="http://www.w3.org/2000/svg" width="1em" height="1em" fill="currentColor" viewBox="0 0 16 16" class="bi bi-facebook">
				                                            <path d="M16 8.049c0-4.446-3.582-8.05-8-8.05C3.58 0-.002 3.603-.002 8.05c0 4.017 2.926 7.347 6.75 7.951v-5.625h-2.03V8.05H6.75V6.275c0-2.017 1.195-3.131 3.022-3.131.876 0 1.791.157 1.791.157v1.98h-1.009c-.993 0-1.303.621-1.303 1.258v1.51h2.218l-.354 2.326H9.25V16c3.824-.604 6.75-3.934 6.75-7.951z"></path>
				                ...
				                <div class="col">
				                    <div class="card bg-dark border-0 shadow-none" style="background: transparent;">
				                        <div class="card-body text-center d-flex flex-column align-items-center p-0"><img class="rounded-circle mb-3 fit-cover" data-bss-hover-animate="tada" width="130" height="130" src="https://cdn.bootstrapstudio.io/placeholders/1400x800.png">
				                            <h5 class="fw-bold card-title mb-0" style="color: var(--bs-card-bg);font-size: 21px;"><strong>Gourab Ashish Paul</strong></h5>
				                            <p class="text-muted card-text mb-2" style="color: var(--bs-card-bg);">Photographer</p>
				                            <ul class="list-inline fs-6 text-muted w-100 mb-0">
				                                <li class="list-inline-item text-center">
				                                    <div class="d-flex flex-column align-items-center"><svg xmlns="http://www.w3.org/2000/svg" width="1em" height="1em" fill="currentColor" viewBox="0 0 16 16" class="bi bi-facebook">
				                                            <path d="M16 8.049c0-4.446-3.582-8.05-8-8.05C3.58 0-.002 3.603-.002 8.05c0 4.017 2.926 7.347 6.75 7.951v-5.625h-2.03V8.05H6.75V6.275c0-2.017 1.195-3.131 3.022-3.131.876 0 1.791.157 1.791.157v1.98h-1.009c-.993 0-1.303.621-1.303 1.258v1.51h2.218l-.354 2.326H9.25V16c3.824-.604 6.75-3.934 6.75-7.951z"></path>
				            ...
				            <div class="row">
				                <div class="col">
				                    <div class="card bg-dark border-0 shadow-none" style="background: transparent;">
				                        <div class="card-body text-center d-flex flex-column align-items-center p-0"><img class="rounded-circle mb-3 fit-cover" data-bss-hover-animate="tada" width="130" height="130" src="https://cdn.bootstrapstudio.io/placeholders/1400x800.png">
				                            <h5 class="fw-bold card-title mb-0" style="color: var(--bs-card-bg);font-size: 21px;"><strong>Subhojit Das</strong></h5>
				                            <p class="text-muted card-text mb-2" style="color: var(--bs-card-bg);">UI/UX designer</p>
				                            <ul class="list-inline fs-6 text-muted w-100 mb-0">
				                                <li class="list-inline-item text-center">
				                                    <div class="d-flex flex-column align-items-center"><svg xmlns="http://www.w3.org/2000/svg" width="1em" height="1em" fill="currentColor" viewBox="0 0 16 16" class="bi bi-facebook">
